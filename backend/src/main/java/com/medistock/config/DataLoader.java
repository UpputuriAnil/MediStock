...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadSeedData() {
        ...
        if (supplierRepository.count() == 0) {
            createSupplier("Apollo Pharmacy", "Rajesh Kumar", "procurement@apollopharmacy.in", "+91 800-200-1122", "Apollo Logistics Hub", "Chennai", "TN", "600001", new BigDecimal("4.90"));
            createSupplier("MedPlus", "Suresh Reddy", "orders@medplusindia.com", "+91 800-425-0000", "MedPlus Wholesale Hub", "Hyderabad", "TS", "500001", new BigDecimal("4.80"));
            createSupplier("PharmEasy", "Anish Sharma", "supply@pharmeasy.in", "+91 800-120-8888", "PharmEasy Fulfillment Center", "Mumbai", "MH", "400001", new BigDecimal("4.70"));
        ...
        if (medicineRepository.count() == 0) {
            createMedicine("Paracetamol 500mg", "Paracetamol 500mg", "Crocin", "Crocin (Paracetamol 500mg) for fever reduction and mild analgesia.", "Analgesic / Antipyretic", "Tablet", "500mg", "Sun Pharma", "MedPlus", "890123456701", 300, 3000, 500, 2.00, 1200);
            createMedicine("Paracetamol 650mg", "Paracetamol 650mg", "Dolo 650", "Dolo 650 (Paracetamol 650mg) by Micro Labs for acute fever and aches.", "Analgesic / Antipyretic", "Tablet", "650mg", "Micro Labs", "MedPlus", "890123456702", 150, 2000, 300, 2.50, 500);
            createMedicine("Amoxicillin 500mg", "Amoxicillin 500mg", "Mox 500", "Mox 500 (Amoxicillin 500mg) broad-spectrum antibiotic capsule.", "Antibiotic", "Capsule", "500mg", "Sun Pharma", "Apollo Pharmacy", "890123456703", 300, 3000, 500, 8.50, 1450);
            ...
            createMedicine("Omeprazole 20mg", "Omeprazole 20mg", "Omez 20", "Omez 20 capsules for peptic ulcer and gastric acid suppression.", "Gastrointestinal", "Capsule", "20mg", "Dr. Reddy's Laboratories", "Apollo Pharmacy", "890123456707", 120, 1500, 200, 7.00, 98);
            ...
            createMedicine("Atorvastatin 10mg", "Atorvastatin 10mg", "Atorva 10", "Atorva 10 lipid-lowering statin for hypercholesterolemia management.", "Statin / Cholesterol", "Tablet", "10mg", "Zydus Lifesciences", "Glenmark Pharmaceuticals", "890123456714", 150, 1500, 250, 12.00, 85);
        ...
        if (inventoryRepository.count() == 0) {
            ...
            if (m1 != null && sup1 != null) {
                createInventory(m1, sup1, "BT-CRO500-01", LocalDate.now().plusMonths(24), LocalDate.now().minusMonths(2), 1200, new BigDecimal("1.20"), new BigDecimal("2.00"), "Main Warehouse", "A1", "S1");
            }
        }
        ...
        if (purchaseOrderRepository.count() == 0) {
            Supplier sup1 = supplierRepository.findAll().stream().findFirst().orElse(null);
            if (sup1 != null) {
                createPurchaseOrder("PO-2026-001", sup1, sup1.getName(), 5, new BigDecimal("12500.00"), "Delivered", LocalDateTime.now().plusDays(5), "Chief Pharmacist");
            }
        }
        ...
        if (expiryTrackingRepository.count() == 0) {
            ...
            if (m1 != null && inv1 != null) {
                createExpiryTracking(m1, inv1, m1.getName(), "BT-OMEZ20-09", LocalDate.now().plusDays(65), 98, 65, "Warning", "Active");
            }
        }
